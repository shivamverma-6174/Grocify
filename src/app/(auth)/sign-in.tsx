...
export default function SignInScreen() {
  ...
  return (
    <SafeAreaView
      className="flex-1 bg-primary dark:bg-secondary overflow-visible"
      edges={["top"]}
    >
      {/* decorative elements */}
      <View
        className="absolute -left-16 top-12 h-56 w-56 rounded-full bg-white/20 z-10"
        style={{ elevation: 5 }} // Android ke liye extra safety
      />

      <View
        className="absolute -right-[74px] top-40 h-72 w-72 rounded-full bg-white/10 z-10"
        style={{ elevation: 5 }}
      />
